...
class Settings(BaseSettings):
    ...
    smtp_host: str = Field(
        default="smtp.mailtrap.io", description="SMTP host for sending emails"
    )
    smtp_user: str = Field(
        default="your-mailtrap-username", description="SMTP username for sending emails"
    )
    smtp_pass: str = Field(
        default="your-mailtrap-password", description="SMTP password for sending emails"
    )
